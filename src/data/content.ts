...
export const projects = [
  {
    ...
    name: "Finoro — Digital Banking & Payments Platform",
    category: "Fintech",
    description: "Secure digital banking, instant payments, and credit scoring-driven micro-lending in one platform.",
    image: "/projects/finora.png",
    techStack: ["Next.js", "Node.js", "Plaid", "Stripe"],
    duration: "6 months",
  },
  {
  ...
  
  {
    ...
    name: "Bellora — Salon & Personal Services Booking App",
    category: "Mobile App",
    description: "Native iOS and Android booking app connecting customers with salons and personal-care providers in real time.",
  ...
  },
  {
    ...
    name: "CuraLink — Telehealth & Doctor Consultation App",
    category: "Healthcare Mobile App",
    description: "Native app connecting patients with doctors for video consultations, e-prescriptions, and appointment scheduling.",
  ...
  },
  {
    ...
    name: "Nearbly — Local Business Discovery & Reviews App",
    category: "Mobile App",
    description: "Discover local businesses, read and write reviews, browse photos, and book reservations on the go.",
    image: "/projects/nearbly.png",
    techStack: ["React Native", "Elasticsearch", "PostGIS"],
    duration: "6 months",
  },
  {
